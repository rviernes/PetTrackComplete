...
<div class="content-wrapper">
    ...
    <div class="card">
            ...
            <h3 class="header" id="pet_name_id">Register Pet</h3>
            <br> @if(Session::has('fail')) <div class="alert alert-danger" role="alert" id="messageModal">
                {{ Session::get('fail') }}
            </div> @endif

            <!-- Main content -->
            <form class="cmxform" action="{{ route('veterinary.addpatient') }}" enctype="multipart/form-data" method="post" id="addPet"> @csrf <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="form-group" 
                                    ...
                                    <select class="form-control custom-select" name="pet_type_id" id="pet_type_id">
                                        ...
                                        <option value="{{ $pet_type->id }}" selected>{{ $pet_type->type_name }}</option> 
                                        @endforeach
                                    </select>
