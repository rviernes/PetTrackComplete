  ...
  <div class="card-header">
    ...
    <form action="{{ route('admin.usersearch') }}" method="get">
        <div class="float-right">
          ...
          <a class="btn btn-success" style="margin-left: 10px;" href="/admin/CRUDusers/Add"><i class="fas fa-user"></i> Create User </a>
        </div>
      </form>
  </div>
    ...
    <table class="table table-striped table-valign-middle">
      ...
      <tbody> 
        ...
        <tr>
          ...
          <td>{{ $userAccounts->usertype }}</td>
          <td class="project-actions">
            <a class="btn btn-primary editbt" data-toggle="modal" data-target="#viewModal{{$userAccounts->id}}">
              <i class="fas fa-folder"></i>
            </a>
            <a class="btn btn-info editbt" href="/admin/CRUDusers/Edit/{{ $userAccounts->id }}">
        ...
        <div class="modal fade modalFD" id="deleteModal{{ $userAccounts->id }}" tabindex="-1" role="dialog" aria-hidden="true" >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form action=" /admin/CRUDusers/delete/{{$userAccounts->id}} " method="GET">
                {{ csrf_field() }}
