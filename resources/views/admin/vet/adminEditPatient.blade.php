...
<div class="card" style="width: auto; margin-left:20px; margin-right:20px; text-align: left; padding: 20px">
        <a class="btn btn-error btn-sm" href="/admin/viewPets/{{ $getCustID->customer_id }}" style="text-align: left;">
    ...
    <!-- Main content -->
    <form action="/admin/adminEditPatient/{{ $editPet->pet_id }}/save" method="post" class="cmxform" id="editPet">
@csrf
